...
from networks.PSPNet import resnet as models
...
class Baseline(nn.Module):
    def __init__(self, layers=50, bins=(1, 2, 3, 6), dropout=0.1, num_classes=4, zoom_factor=8, use_ppm=True,
...
if __name__ == '__main__':
    ...
    model = Baseline(layers=50, bins=(1, 2, 3, 6), dropout=0.1, num_classes=4, zoom_factor=1, use_ppm=True,
